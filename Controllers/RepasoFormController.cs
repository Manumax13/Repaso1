...
using Repaso1.Models; //AGREGAMOS

namespace Repaso1.Controllers
{
    public class RepasoFormController : Controller
    {
        private readonly ILogger<RepasoFormController> _logger;

        public RepasoFormController(ILogger<RepasoFormController> logger)
        {
            _logger = logger;
        }

        public IActionResult VistaRepasoForm()
        {
            return View("VistaRepasoForm");
        }
...
[HttpGet]
public ActionResult VistaRepasoForm(Curso objCurso)
{
